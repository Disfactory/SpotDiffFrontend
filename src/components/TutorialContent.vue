<template>
  <div class="content qusestionA" v-if="stageOfTutorial === 1">
    ...
    <div class="identify-box border-brown">
      <InnerBoundingBox :class="{ 'inner-bounding-box': true, mask: isAnswerSend }" />
      <div class="address">彰化縣・鹿港鎮</div>
      <PhotoYear2017 class="photo-year" />
      <img src="@/assets/img/tutorial1-2017.png" />
    </div>

    <div class="button-group" v-if="!isAnswerSend">
  ...
  <div class="content qusestionB" v-if="stageOfTutorial === 2">
    ...
    <div class="button-group button-group-2" v-if="!isAnswerSend">
